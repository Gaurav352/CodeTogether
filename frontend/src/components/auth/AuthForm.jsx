  ...
  return (
    <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white/5 relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button className="w-full bg-brand-purple hover:bg-brand-pink text-ghost-white hover:text-navy py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-brand-purple/20 mt-4">
      ...
      <p className="mt-8 text-center text-sm text-ghost-white/50">
        ...
        <button 
          ...
          className="text-brand-pink hover:text-brand-purple font-bold transition-colors underline underline-offset-4"
        >
